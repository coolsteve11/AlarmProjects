...
import com.javapapers.androidalarmclock.databinding.ActivityGetHrBinding;
public class UserDataActivity extends Activity {

    private ActivityGetHrBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_get_hr);
  ...
  //      binding.viewPager.addOnPageChangeListener(
                new ViewPager.SimpleOnPageChangeListener() {
                    ...
                    public void onPageSelected(int position) {
                        // When swiping between pags, select the
                        // corresponding tabe.
