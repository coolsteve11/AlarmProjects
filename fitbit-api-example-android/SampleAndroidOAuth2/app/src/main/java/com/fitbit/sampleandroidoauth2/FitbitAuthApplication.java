...
public class FitbitAuthApplication extends Application {
    ...
    private static final String CLIENT_SECRET = "c5ead87f1c6737f86971377ac71d7d9b";
    private static final String CLIENT_ID = "228H24";
    private static final String REDIRECT_URL = "https://www.fitbit.com/user/5TZLG6";
     ...
     */
    //!! THIS SHOULD BE IN AN ANDROID KEYSTORE!! See https://developer.android.com/training/articles/keystore.html
    private static final String SECURE_KEY = "94nY2hXXw0gROb7m6kTvbOhZbeOik9dwg7cj8CWRouM=";
    ...
    public static AuthenticationConfiguration generateAuthenticationConfiguration(Context context, Class<? extends Activity> mainActivityClass) {
        ...
        try {
            ...
            String clientId =CLIENT_ID;// bundle.getString("com.fitbit.sampleandroidoauth2.CLIENT_ID");
            String redirectUrl = REDIRECT_URL;//bundle.getString("com.fitbit.sampleandroidoauth2.REDIRECT_URL");
